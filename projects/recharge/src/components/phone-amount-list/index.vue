<template>
  <view class="phone-amount-list-component" :class="{ disabled }">
    <view v-if="loading" class="amount-placeholder">
      <view class="amount-loading">
        <Loading size="24px" color="#c9c9c9" />
      </view>
    </view>
    <view v-else-if="list.length" class="phone-amount-list">
      <view
      ...
      >
        <view class="recharge-amount-child min">
